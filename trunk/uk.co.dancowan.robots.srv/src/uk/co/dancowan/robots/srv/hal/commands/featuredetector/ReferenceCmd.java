...
/**
 * Enable frame differencing mode.
 * 
 * @author Dan Cowan
 * @since version 1.0.0
 */
public class ReferenceCmd extends AbstractCommand
{
	public static final String ID = "Difference";

	private static final byte[] HEADER = new byte[] {'#', '#', 'g'};
	private static final String COMMAND = "g0";
