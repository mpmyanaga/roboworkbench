...
/**
 * Enable colour segmentation mode.
 * 
 * @author Dan Cowan
 * @since version 1.0.0
 */
public class SegmentationCmd extends AbstractCommand
{
	public static final String ID = "Segmentation";

	private static final byte[] HEADER = new byte[] {'#', '#', 'g'};
	private static final String COMMAND = "g1";

	/**
	 * C'tor
	 */
	public SegmentationCmd()
	{
		super(4);
	}
	...
	/**
	 * Writes the byte translation of the result of a call to <code>getCommandString()
