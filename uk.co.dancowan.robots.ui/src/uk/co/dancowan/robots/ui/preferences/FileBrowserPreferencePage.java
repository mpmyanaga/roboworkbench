 ...
 * @since version 1.0.0
 */
public class FileBrowserPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
	/**
	 * C'tor
	 * 
	 ...
	 */
	public FileBrowserPreferencePage()
	{
		super(GRID);
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription("Specify how the File Browser behaves");
	}
	...
	public void createFieldEditors()
	{
		...
		addField(new DirectoryFieldEditor(PreferenceConstants.FILE_BROWSER_ROOT, "&File browser root directory ", getFieldEditorParent()));
	}
