 ...
 * @since version 1.0.0
 */
public class NNTestCmd extends AbstractCommand
{
	public static final String ID = "NNTest";
	private static final int TIMEOUT = 300;

	private static final byte[] HEADER = new byte[] {'#', '#', 'n', 'x'};
	...
	{
		int index = SrvHal.getCamera().getDetector().getFocusPattern().getIndex();
		return ID + "(" + index + ")";
	}
