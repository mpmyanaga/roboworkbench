...
/**
 * Enable edge detection mode.
 * 
 * @author Dan Cowan
 * @since version 1.0.0
 */
public class EdgeDetectionCmd extends AbstractCommand
{
	public static final String ID = "Edge Detection";

	private static final byte[] HEADER = new byte[] {'#', '#', 'g'};
	private static final String COMMAND = "g2";

	/**
	 * C'tor
	 */
	public EdgeDetectionCmd()
	{
		super(4);
	}
